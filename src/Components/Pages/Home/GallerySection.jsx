...
const GallerySection = () => {
  ...
  return (
    <div className="bg_secondary py-16 px-5">
      ...
      <div className="flex flex-wrap gap-7 md:gap-0 lg:gap-0 justify-center items-center">
        <img
          ...
          className="h-44 w-44 md:h-56 lg:h-80  md:w-56 lg:w-80 object-cover border border-black"
          data-aos="fade-up"
        />
        <img
        ...
        />
        <img
          src="https://i.ibb.co/Rjq7dbN/soft-2.jpg"
          className="h-44 w-44 md:h-56 lg:h-80 md:w-56 lg:w-80 object-cover border border-black"
          data-aos="fade-up"
        />
        <img
          src="https://i.ibb.co/5Wytdnm/13.jpg"
          className="h-44 w-44 md:h-56 lg:h-80  md:w-56 lg:w-80 object-cover border border-black"
          data-aos="fade-up"
        />
      </div>
